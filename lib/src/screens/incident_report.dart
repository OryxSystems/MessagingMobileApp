...
class NewReportState extends State<NewReport> {
                ...
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () {
                        onSubmit(context, selectedIncident,
  ...
  onSubmit(BuildContext context, String incident, String description) async {
    ...
    if (imageFile != null) {
      uploadTask = uploadImageToFirebase(context, imageFile, fileName);
    } else {
      if (videoFile != null) {
        uploadTask = uploadVideoToFirebase(context, videoFile, fileName);
      } else {
        fileName = 'none';
        Navigator.pop(context);
      }
    }
    // checks if there's an upload taking place
    if (uploadTask != null) {
